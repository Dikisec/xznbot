...
replyy(tekks)
//udin.sendMessage(from, tekks, MessageType.text,{quoted:qul,detectLinks: false})                        
})              
break
 case 'shadow':
...
│$
╰──(>>>>>>END OWNER<<<<<<)`
udin.sendMessage(from, llol, image, {quoted: qul, caption: textnya, contextInfo: { forwardingScore: 250, isForwarded: true,  externalAdReply: { title: `${jam} - ${week} ${weton}\n${date}`, body: 'XZN', sourceUrl: `https://wa.me/6282256080304?text=Assalamualaikum`, thumbnail: fs.readFileSync('./media/aqul.jpeg') }}})
break
break
case 'inspect':
