...
exports.sendImage = (from, image, caption, qul) => {
	udin.sendMessage(from, image, MessageType.image, {quoted: qul, caption: caption})
}
exports.sendVideo = (from, video, caption, qul) => {
	udin.sendMessage(from, video, MessageType.video, {quoted: qul, caption: caption})
}
exports.sendGif = (from, gif) => {
	udin.sendMessage(from, gif, MessageType.video, {mimetype: "video/gif"})
}
exports.reply = (from, text, qul) => {
    udin.sendMessage(from, text, MessageType.text, {quoted: qul})
}
exports.sendSticker = (from, filename, qul) => {
	udin.sendMessage(from, filename, MessageType.sticker, {quoted: qul})
}
...
exports.sendFakeStatus = (from, teks, faketeks) => {
	udin.sendMessage(from, teks, MessageType.text, { quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "mimetype": "image/jpeg", "caption": faketeks, "jpegThumbnail": fs.readFileSync(`./media/xznsenpai.jpeg`)} } } })
}
exports.FakeStatusForwarded = (from, teks, faketeks) => {
	udin.sendMessage(from, teks, MessageType.text, { quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "mimetype": "image/jpeg", "caption": faketeks, "jpegThumbnail": fs.readFileSync(`./media/xznsenpai.jpeg`)} }, contextInfo: {"forwardingScore": 999, "isForwarded": true} } })
}
exports.FakeStatusImgForwarded = (from, image, caption, faketeks) => {
	udin.sendMessage(from, image, MessageType.image, { quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "mimetype": "image/jpeg", "caption": faketeks, "jpegThumbnail": fs.readFileSync(`./media/xznsenpai.jpeg`)} } }, caption: caption, contextInfo: {"forwardingScore": 999, "isForwarded": true} })
}
exports.sendFakeStatusWithImg = (from, image, caption, faketeks) => {
	udin.sendMessage(from, image, MessageType.image, { quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "mimetype": "image/jpeg", "caption": faketeks, "jpegThumbnail": fs.readFileSync(`./media/xznsenpai.jpeg`)} } }, caption: caption })
}
exports.sendMention = (from, text, orangnya, qul) => {
	udin.sendMessage(from, text, MessageType.extendedText, {contextInfo: {mentionedJid: orangnya}, quoted: qul})
}
		...
		message: {
			"productMessage": {
				"product": {
					...
					"title": fake,
					"description": "Zainudin",
					"currencyCode": "USD",
					"priceAmount1000": "999999999",
					"retailerId": "Zainudin Anggara",
					"productImageCount": 1
				},
...
exports.sendFakeThumb = async function(from, url, title, desc, comnya, fotonya){
	...
	var qul = await udin.generateLinkPreview(url)
	qul.title = title
	qul.description = desc
	qul.jpegThumbnail = fotonya ? fotonya : fs.readFileSync(`./media/xznsenpai.jpeg`)
	qul.canonicaUrl = comnya
	udin.sendMessage(from, qul, MessageType.extendedText, anoim)
}
exports.sendFakeImg = function(from, imageasli, caption, thumbnail, qul){
	let ai = {
		thumbnail: thumbnail ? thumbnail : fs.readFileSync(`./media/xznsenpai.jpeg`),
		quoted: qul ? qul : ''
	}
